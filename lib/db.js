...
function Db(){
	...
	Db.prototype.createUserHabit = function(user_id, habit_id, start_date, lastupdate_date, is_Active){
		var deferred = Q.defer();
    ...
    Db.prototype.updateLastUpdateDate= function(user_id, lastupdate_date)
    {
        var deferred = Q.defer();
        ...
        var condition = {userId : user_id, isActive:true}
          , options = { multi: true }
          , update = { lastUpdateDate: lastupdate_date };
    ...
    Db.prototype.createHabit = function(trigger, action, goal){
    	var deferred = Q.defer();
